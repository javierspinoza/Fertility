...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ secure_asset('assetsDashboard/assetsHome/login/libraryJavierSpinoza/confirmAndResetPassword/css/style.css') }}">
...
<body>
    ...
    <img class="wave" src="{{ secure_asset('assetsDashboard/assetsHome/login/libraryJavierSpinoza/confirmAndResetPassword/img/wave.png') }}">
    <div class="container">
        <div class="img">
            <img src="{{ secure_asset('assetsDashboard/assetsHome/login/libraryJavierSpinoza/confirmAndResetPassword/img/bg.svg') }}">
        </div>
        <div class="login-content">
            <form method="POST" action="{{ route('password.email') }}">
                @csrf
                <img src="{{ secure_asset('assetsDashboard/assetsHome/login/libraryJavierSpinoza/confirmAndResetPassword/img/avatar.svg') }}">
    ...
    <script type="text/javascript" src="{{ secure_asset('assetsDashboard/assetsHome/login/libraryJavierSpinoza/confirmAndResetPassword/js/main.js') }}">
    </script>
</body>
