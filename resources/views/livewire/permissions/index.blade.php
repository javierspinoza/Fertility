                        ...
                        <div class="card card-primary">
                            ...
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-end mb-n4">
                                    <a href="{{ route('permissions.create', ['search' => $search]) }}" wire:navigate
                                                    ...
                                                    @foreach ($permissions as $permission)
                                                        <tr>
                                                            <td class="td-actions text-center">
                                                                <a href="{{ route('permissions.edit', ['id' => $permission->id, 'search' => $search, 'page' => $permissions->currentPage()]) }}"
                                                                    wire:navigate
                                                                ...
                                                                <button wire:click="confirmRemoved({{ $permission->id }})"
