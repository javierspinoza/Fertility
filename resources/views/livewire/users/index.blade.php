                        ...
                        @can('user_admin')
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-end mb-n4">
                                    <a href="{{ route('users.create', ['search' => $search]) }}" wire:navigate
                                    ...
                                    <div class="row table-responsive">
                                        <table class="table table-sm table-bordered">
                                            <thead class="bg-primary text-white">
                                                ...
                                                <th>Ultima Vez Conectado <i class="fas fa-sort"></i>
                                                </th>
                                                <th>Estado <i class="fas fa-sort"></i>
                                                </th>
                                                    ...
                                                    <tr>
                                                        @can('user_admin')
                                                            <td class="td-actions text-center">
                                                                <a href="{{ route('users.show', ['id' => $user->id, 'search' => $search, 'page' => $users->currentPage()]) }}"
                                                                    wire:navigate
                                                                ...
                                                                <a href="{{ route('users.edit', ['id' => $user->id, 'search' => $search, 'page' => $users->currentPage()]) }}"
                                                                    wire:navigate
                                                                ...
                                                                <button wire:click="confirmRemoved({{ $user->id }})"
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge bg-{{ $user->last_seen >= now()->subMinutes(2) ? 'success' : 'danger' }}">{{ $user->last_seen >= now()->subMinutes(2) ? 'En Linea' : 'Desconectado' }}</span>
                                                        </td>
                                                        <td>
